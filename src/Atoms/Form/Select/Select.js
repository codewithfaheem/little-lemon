...
function Select(props) {
  ...
  return (
    <div class="relative z-0 w-full mb-6 group">
        <select id={props.id}  required={props.required} className="block py-1.5 px-0 w-full text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="">
            {options.map((item,i)=>{
                return(
